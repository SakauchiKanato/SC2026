<!--
  ...
  地域名のみ必須。ライフスタイルデータ・「企業・自治体が実現したいこと」は任意
  （課題点・期待する未来を両方入力した場合、登録者自身の最初の投稿として
  area_challenge_requestsに作成される。バックエンド側の挙動、変更していない）。
      ...
      <form class="area-form-view__card" @submit.prevent="handleSubmit">
        ...
        <div class="area-form-view__grid">
          ...
          <div class="area-form-view__field area-form-view__field--wide">
            ...
            ></textarea>
            <p v-if="errors.other" class="area-form-view__error">{{ errors.other }}</p>
          </div>
        </div>
        ...
        <p class="area-form-view__section-note">
          ここで入力すると、あなたの団体からの最初の投稿として地域詳細ページに掲載されます。未入力の場合は、後から地域詳細ページで追加できます。
        </p>
        ...
        <div class="area-form-view__footer">
          <span class="area-form-view__footer-hint">地域名を入力すると登録できます</span>
